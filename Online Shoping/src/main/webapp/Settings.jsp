...
<form id="cardId" class="card" action="addSettings.jsp" method="post" >
<div class="row">
    <div class="col">
  ...
  <div class="alert alert-primary" role="alert">
	...
	We'll never share your Details number with anyone else.<br>
		it s only propose for delivery
</div>
</div>
