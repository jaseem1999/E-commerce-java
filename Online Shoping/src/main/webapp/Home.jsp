...
</svg><span class="badge"><% if(c != null){
		out.print(c);
	}else{
		out.print("");
	}
    ...
    <div class="col">
      <div class="p-3">
      	<div class="card" style="width: 18rem;">
  			<img src="<%=d.getImg() %>" class="card-img-top" alt="...">
  			<div class="card-body">
    			<h5 class="card-title"><%=d.getName() %>
    			</h5>
    			
    			<p class="card-text"><%=d.getDes() %></p>
    			<a href=<%
    				if(name != null){
    					out.print("addCart.jsp?id="+d.getProid());
    				}else{
    					out.print("logIn.jsp");
    				}
    			%>
...
</svg><%=d.getPrice()%></a><br/><br/>
    			<%
    			if(d.getOffer() != null){
    				out.print("Offer "+d.getOffer());
    			}else{
    				out.print("");
    			}
    			%>
...
session.setAttribute("proPrice", proPrice);
%>
