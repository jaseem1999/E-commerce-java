...
<div class="list-group" id="mainItems">
  ...
  <a href="#" class="list-group-item list-group-item-action list-group-item">A simple secondary list group item</a>
  <a href="#" class="list-group-item list-group-item-action list-group-item">A simple success list group item</a>
