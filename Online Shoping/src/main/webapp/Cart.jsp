...
PreparedStatement stm =con.prepareStatement("select * from cart where user_id='"+userid+"'");
...
<div class="card" id="cardId">
	<div class="title">Ordered ID : <%=rs.getInt(1)%> </div><br>
	
	<div class="Cart">
	<div class="row">
		<div class="col">
			<div class="CartN"> Product Name :<%=rs.getString(2)%></div>
		</div>
		<div class="col">
			<div class="CartD">Product Description :<br> <%=rs.getString(3)%></div>
		</div>
		<div class="col">
	    	<div class="Cartimg"><img alt="img" src="<%=rs.getString(4)%>" width="100px"> </div>
	    </div>
	    <div class="col">
			<div class="price"> price : <%=rs.getString(5)%></div>
		</div>
		<div class="col">
			<div class="offer">Offer<%=rs.getString(6)%></div>
		</div>
	</div>
	</div>
